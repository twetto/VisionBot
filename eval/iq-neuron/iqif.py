...
class lifnet(object):
    def __init__(self):
        ...
        liblif.lif_network_adaptive_term.argtypes = [ctypes.c_void_p, ctypes.c_int]
        liblif.lif_network_adaptive_term.restype = ctypes.c_float
    ...
    def adaptive_term(self, neuron_index):
        return liblif.lif_network_adaptive_term(self.obj, neuron_index)
